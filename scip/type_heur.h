...
typedef struct SCIP_DivingData SCIP_DIVINGDATA;   /**< structure for data collection */
 ...
 *  - divingdata      : data structure for data collection
...
#define SCIP_DECL_HEUREXEC(x) SCIP_RETCODE x (SCIP* scip, SCIP_HEUR* heur, SCIP_HEURTIMING heurtiming, \
      SCIP_Bool nodeinfeasible, SCIP_DIVINGDATA* divingdata, SCIP_RESULT* result)
