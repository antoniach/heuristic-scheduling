   ...
   )
{
   ...
   if( nsubsols > 0 )
   {
      if( SCIPheurUsesShadowMode(heur) )
      {
         ...
         SCIP_CALL( SCIPtranslateSubSolsShadowMode(scip, subscip, heur, subvars, &newsol, &feasible, &success, NULL) );
...
{  /*lint --e{715}*/
   ...
   *result = SCIP_DIDNOTFIND;
   ...
   retcode = wrapperDins(scip, subscip, heur, heurdata, vars, fixedvars, fixedvals, result, nvars, nbinvars, nintvars, binfixings, intfixings, nsubnodes, divingdata);
