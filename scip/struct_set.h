...
struct SCIP_Set
{
   ...
   SCIP_DIVINGDATA**     heurcalls;          /**< calls of (diving) heuristics for data collection */
   ...
   int                   nheurcalls;         /**< number of successfull (diving) heuristic calls */
   int                   heurcallssize;      /**< size of heurcalls array */
