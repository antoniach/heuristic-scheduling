...
struct SCIP_Diveset
{
   ...
   SCIP_Real             timelimit;          /**< limit time spent on a dive */
   int                   lpsolvefreq;        /**< LP solve frequency for diving heuristics */
   int                   maxlpiterofs;       /**< additional number of allowed LP iterations */
   int                   nbacktracks;        /**< if backtracking is used, how often? (1: scip default) */
   int                   maxdivedepth;       /**< how deep should we at most dive? (-1: scip default) */
...
/* structure for data collection for diving heuristics */
struct SCIP_DivingData
{
   char*                 heurname;           /**< name of diving heuristic */
   SCIP_Longint          nodenumber;         /**< successively assigned number of the node */
   int                   nodedepth;          /**< depth of the node */
   int                   divingdepth;        /**< depth to which the heuristic dived */
   int                   nsolsfound;         /**< number of soltuion found at current call */
   int                   nbestsolsfound;     /**< number of incumbent found at current call */
   int                   nnodes;             /**< number of nodes in subscip of LNS heuristic */
   SCIP_Real             bestprimval;        /**< objective value of the best primal found in current call */
   SCIP_Real             lpresolvedomchgquot;/**< percentage of immediate domain changes during probing to trigger LP resolve of the dive */
   SCIP_Real             time;               /**< time for which the heuristic was run */
   SCIP_Real             solvingtime;        /**< point of time in the solving process the heuristic was called */
};
