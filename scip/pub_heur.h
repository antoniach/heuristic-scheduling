...
/** gets diving depth for data collection  */
...
/** sets diving depth for data collection  */
void SCIPdivingdataSetDivingDepth(
   SCIP_DIVINGDATA*      divingdata,         /**< data structure for data collection */
   int                   value               /**< value the depth sould be set to */
   );
...
/**if backtracking is applied, get the maximal backtrack level */
SCIP_EXPORT
int SCIPdivesetGetBacktrackLimit(
   SCIP_DIVESET*         diveset             /**< diving settings */
   );

/** how deep should we at most dive? */
SCIP_EXPORT
