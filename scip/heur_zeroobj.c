...
{  /*lint --e{715}*/
   ...
   SCIP_CALL( SCIPapplyZeroobj(scip, heur, result, heurdata->minimprove, nnodes, divingdata) );
   ...
   )
{
   ...
   *result = SCIP_DIDNOTFIND;
   ...
   retcode = setupAndSolveSubscip(scip, subscip, heur, result, minimprove, nnodes, divingdata);
